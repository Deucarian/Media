...
3. Use its buttons to exercise play with c#, play with component, stop.
4. Inspect the configured hosts and triggers, then open
   [MediaWorkflow.cs](../Samples~/DefinitionWorkflow/Runtime/MediaWorkflow.cs). It is the caller
...
- **Play with C#**: `MediaWorkflow.Play()`.
- **Play with component**: `MediaWorkflow.PlayComponent()`.
- **Stop**: `MediaWorkflow.Stop()`.
